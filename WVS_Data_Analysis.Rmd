...
### Variance of Different Numbers of Categories
```{r}
Variances <- c()
for(i in 1:895){
...
TwoCategoryQuestions<- WVS_Data_Precentages3[,c("V24_1","V24_2",
                                                "V66_1","V66_2",
                                                "V82_1","V82_2",
                                                "V83_1","V83_2" ,
                                                "V148_1","V148_2",
...
```{r}
MentionQuestions<- WVS_Data_Precentages3[,c("V12_1", "V12_2",
                                                       "V13_1", "V13_2",
                                                       "V14_1", "V14_2",
                                                       "V15_1", "V15_2",
                                                       "V16_1", "V16_2",
...
MultipleCat_Questions<- WVS_Data_Precentages3[,!colnames(WVS_Data_Precentages3) %in% remove]
...
```
```{r}
BinaryQuestions_RemoveVarible <- colnames(WVS_Data_Precentages3[,c("V12_2","V13_2", "V14_2", "V15_2", 
                                                       "V16_2", "V17_2", "V18_2", 
                                                       "V19_2",  "V20_2", "V21_2", 
                                                       "V22_2", "V36_2", "V37_2", 
                                                       "V38_2",  "V39_2", "V40_2", 
                                                       ...
                                                       "V178_5","V179_5","V180_5","V243_2",
                                                       "V244_2","V245_2", "V246_2")])
                                         
                                    
WVS_Data_Precentages4 <- WVS_Data_Precentages3[,!colnames(WVS_Data_Precentages3) %in% BinaryQuestions_RemoveVarible] 
```
...
PCA_Analysis_Data <- WVS_Data_Precentages4
...
fullregression <- lm(log(GDP_Control$RE_Generation +1) ~GDP_Control$PC1 + GDP_Control$PC2 + 
                       GDP_Control$PC3 + GDP_Control$PC4 + GDP_Control$PC5 + Control)
summary(fullregression)
```
...
#Check Assumptions
```{r}
#Check normality of Principle Components
y <- Data_Control$RE_Generation
PC1 <- Data_Control$PC1
PC2 <- Data_Control$PC2
PC3 <- Data_Control$PC3
PC4 <- Data_Control$PC4
PC5 <- Data_Control$PC5
...
```{r eval=FALSE}
fit_5 <- nls(y ~ a^PC1 + b^PC2 + d^PC3 + e^PC4 + f^PC5 + g^(Control))
#letter c is a function of some type....
```
```{r eval=FALSE}
fit_4 <- nls(y ~ a^PC1 + b^PC2 + d^PC3 + e^PC4 + g^(Control))
#letter c is a function of some type....
cor(y, predict(fit_4))
summary(fit_4)
```

With only the first 2 components
```{r}
fit_2 <- nls(y ~ a^PC1 + b^PC2 + g^(Control))
#letter c is a function of some type....
