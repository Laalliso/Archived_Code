...
write.csv(PCA_Loadings, file= "PCA_Loadings_11.26.csv")
...
write.csv(PCA_Loadings_Cleaned, file= "PCA_Loadings_Cleaned_11.26.csv")
```
...
#Questions to Remove based on national sensitiviey analysis.
#AdminaNA
 [1] "V74B"      "V90"       "V91"       "V92"       "V93"       "V94"       "v160A"     "v160B"     "v160C"    
[10] "v160D"     "v160E"     "v160F"     "v160G"     "v160H"     "v160I"     "v160J"     "V217_ESMA" "V218_ESMA"
[19] "V224_ESMA" "V220_ESMA" "V221_ESMA" "V222_ESMA" "V228A"     "V228B"     "V228C"     "V228D"     "V228E"    
[28] "V228F"     "V228G"     "V228H"     "V228I"     "V228J"     "V228K"     "V243_AU"   "V244_AU"   "V56_NZ"   
[37] "V203A"     "V207A" 
#Missing - none
#Don'tKnow
"V133" "V140" "V193" "V152"
...
Cleaned_Individual_Data<- Individual_Data[,-which(names(Individual_Data) %in% c("V144", "V247", "V254","V256","V219_ESMA", "V228", "V228_2", "V57","V58","V229","V230","V234","V235","V236","V237","V238","V240","V248","V250", "V253","V255","V256", "V74B","V90","V91","V92","V93","V94","v160A","v160B","v160C","v160D","v160E",  "v160F","v160G","v160H","v160I","v160J",
...
"V152", "V215", "V241", "V242", "V249", "V215_01","V215_02","V215_03","V215_04","V215_05","V215_06","V215_07",
...
```{r}
Political_Infrastructure <- 
```

#Linear Regression
```{r}
fullregression <- lm(Cost_Performance_Wind$X.Cost.Over.Run ~ Cost_Performance_Wind$PC1 + Cost_Performance_Wind$PC2 + 
                       Cost_Performance_Wind$PC3 + Cost_Performance_Wind$PC4 + 
                       Cost_Performance_Wind$Offshore)
